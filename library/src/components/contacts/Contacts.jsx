    ...
    <section className="contacts" id="contacts">
      ...
      <div className="aligner">
        <div className="contacts__adress-and-map">
          ...
          <a className="contacts__map" href="https://www.google.com/maps/place/286+Cadman+Plaza+W,+Brooklyn,+NY+11201,+USA/@40.6952685,-73.9916289,19z/data=!4m6!3m5!1s0x89c25a49b649b8c3:0x6342a2291cea2e!8m2!3d40.6956458!4d-73.9912976!16s%2Fg%2F11s2lgz8ns?entry=ttu">
            <img className="contacts__img" src="./assets/img/other/map.png" alt="map" />
            </a>
        </div>
      </div>
    </section>
